...
const metrics: Metric[] = [
  {
    ...
    change: "+5%",
    direction: "up",
    description: "Users logged into MB3 at least once",
  ...
  },
  {
    ...
    change: "+8%",
    direction: "up",
    description: "Active legacy users migrated to MB3 this week",
  ...
  },
  {
    ...
    change: "+3%",
    direction: "up",
    description: "MB3 users who interacted with search, moodboard, or project",
